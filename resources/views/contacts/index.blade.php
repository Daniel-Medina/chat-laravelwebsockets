<x-app-layout>
    ...
    <div class="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        ...
        <div class="flex justify-end mb-4">
            <a href="{{ route('contacts.create') }}" class="btn btn-primary">Crear Contacto</a>
        </div>
                        ...
                        @foreach ($contacts as $contact)
                            ...
                            <tr class="bg-white border-b dark:bg-gray-800 dark:border-gray-700">
                                <th scope="row"
                                    ...
                                    <img src="{{$contact->user->profile_photo_url}}" class="w-12 h-12 object-cover object-center" alt="">
                                </th>
                                <td class="px-6 py-4">
                                    {{$contact->name}}
                                </td>
